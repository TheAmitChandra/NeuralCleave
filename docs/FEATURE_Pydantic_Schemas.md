...
#### [NEW] [agents.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/agents.py)
...
#### [NEW] [workflows.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/workflows.py)
...
#### [NEW] [memory.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/memory.py)
Create `backend/app/schemas/memory.py` with schemas:
- `MemoryStoreRequest`
- `MemoryResponse`
- `MemorySearchResponse`

#### [NEW] [tools.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/tools.py)
Create `backend/app/schemas/tools.py` with schemas:
- `ToolListItem`
- `ToolExecuteRequest`
- `ToolExecuteResponse`

#### [NEW] [events.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/events.py)
...
#### [NEW] [observability.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/observability.py)
...
#### [NEW] [approvals.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/approvals.py)
Create `backend/app/schemas/approvals.py` with schemas:
- `ApprovalResponse`
- `RejectRequest`
- `CancelRequest`

#### [NEW] [governance.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/governance.py)
Create an empty placeholder `backend/app/schemas/governance.py` file or keep it as approvals.

#### [MODIFY] [__init__.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/schemas/__init__.py)
Update `backend/app/schemas/__init__.py` to import and expose all the newly defined schemas.

### API Routes

#### [MODIFY] [agents.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/agents.py)
Import the schema classes from `app.schemas.agents` and remove their inline class definitions.

#### [MODIFY] [workflows.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/workflows.py)
Import the schema classes from `app.schemas.workflows` and remove their inline class definitions.

#### [MODIFY] [memory.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/memory.py)
Import the schema classes from `app.schemas.memory` and remove their inline class definitions.

#### [MODIFY] [tools.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/tools.py)
Import the schema classes from `app.schemas.tools` and remove their inline class definitions.

#### [MODIFY] [events.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/events.py)
Import the schema classes from `app.schemas.events` and remove their inline class definitions.

#### [MODIFY] [approvals.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/approvals.py)
Import the schema classes from `app.schemas.approvals` and remove their inline class definitions.

#### [MODIFY] [observability.py](file:///c:/Amit-Projects/AI-Projects/CortexFlow/backend/app/api/v1/observability.py)
