...
describe("VoiceSection – empty output device not sent", () => {
  it("does not include output_device in PATCH payload when no device is selected", async () => {
    render(<SettingsPage />);
    ...
    expect(patchCall[1]).not.toHaveProperty("output_device");
  });
});
