...
describe("VoiceSection – Restart Gateway button", () => {
  it("Restart Gateway button is not visible when not in Tauri (browser mode)", async () => {
    render(<SettingsPage />);
    expect(screen.queryByRole("button", { name: /restart gateway/i })).toBeNull();
  });
});
