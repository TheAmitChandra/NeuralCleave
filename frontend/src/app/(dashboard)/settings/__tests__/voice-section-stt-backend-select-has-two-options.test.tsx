...
describe("VoiceSection – STT Backend select options count", () => {
  it("has exactly two options: Disabled and Local Whisper", () => {
    render(<SettingsPage />);
    const disabled = screen.getByRole("option", { name: "Disabled" });
    const whisper = screen.getByRole("option", { name: "Local Whisper (offline)" });
