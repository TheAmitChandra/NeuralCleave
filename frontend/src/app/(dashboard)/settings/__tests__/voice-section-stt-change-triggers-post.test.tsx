...
describe("VoiceSection – save triggers POST /settings/voice", () => {
  it("calls POST /settings/voice when Voice Save is clicked", async () => {
    ...
    expect(postMock).toHaveBeenCalledWith(
      "/settings/voice",
      expect.objectContaining({ stt: expect.any(String) }),
    );
  });
});
