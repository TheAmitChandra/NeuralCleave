...
describe("VoiceSection – default stt_model in save payload", () => {
  it('sends stt_model: "base" by default', async () => {
    ...
    expect((voiceCall![1] as Record<string, string>).stt_model).toBe("base");
  });
});
