...
describe("VoiceSection – changing STT Backend to Disabled", () => {
  it('sends stt: "none" after user selects Disabled from the dropdown', async () => {
    ...
    fireEvent.change(sttSelect, { target: { value: "none" } });
