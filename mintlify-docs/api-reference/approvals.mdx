...
```bash
curl -X POST http://localhost:8765/api/v1/approvals/550e8400.../approve \
...
```bash
curl http://localhost:8765/api/v1/approvals/allowlist
curl -X POST http://localhost:8765/api/v1/approvals/allowlist \
  -H "Content-Type: application/json" -d '{"pattern": "git", "arg_pattern": "^git log"}'
curl -X DELETE http://localhost:8765/api/v1/approvals/allowlist/3
```
...
```bash
curl http://localhost:8765/api/v1/approvals/policy
curl -X POST http://localhost:8765/api/v1/approvals/policy \
